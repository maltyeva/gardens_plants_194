...
class ParksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post parks_url, params: { park: { address: @park.address, banner_url: @park.banner_url, name: @park.name, rating: @park.rating } }
    end
  ...
  test "should update park" do
    patch park_url(@park), params: { park: { address: @park.address, banner_url: @park.banner_url, name: @park.name, rating: @park.rating } }
